...
# ADR-001: Modular Monolith for Core Runtime
...
Keep a modular monolith with explicit package boundaries rather than distributed services for the first releases.
